...
class ControllerCommonHeader extends Controller
{
    ...
    // OCFilter end
        ...
        foreach ($categories as $category) {
            if ($category['top']) {
                $categories_brands = $this->model_catalog_category->getCategoryBrands($category['category_id']);
                // Level 2
                $children_data = array();
                $children = $this->model_catalog_category->getCategories($category['category_id']);
                foreach ($children as $child) {
                    $categories_brands2 = $this->model_catalog_category->getCategoryBrands($child['category_id']);
                    $filter_data = array(
                    ...
                    foreach ($children3 as $child_lv3) {
                        //$categories_brands3 = $this->model_catalog_category->getCategoryBrands($child['category_id']);
                    ...
                    $children_data[] = array(
                        ...
                        //'categories_brands' => $categories_brands3,
