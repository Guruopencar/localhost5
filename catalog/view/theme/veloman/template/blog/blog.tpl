        ...
        <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
            <div class="blog blog_post">
                ...
                <div class="blog_stats">
                    ...
                    <span><i class="fa fa-user"></i><b class="text"><?php echo $text_posted_by; ?></b> <b class="hl"><?php echo $author; ?></b></span><?php } ?>    <?php if($post_date_added_status){ ?>
                    <span><i class="fa fa-clock-o"></i><b class="text"><?php echo $text_posted_on; ?></b> <b class="hl"><?php echo $date_added_full; ?></b></span><?php } ?>    <?php if($post_page_view_status){ ?>
                    <span><i class="fa fa-eye"></i><b class="text"><?php echo $text_read; ?></b> <b class="hl"><?php echo $new_read_counter_value; ?></b></span><?php } ?>    <?php if($post_comments_count_status){ ?>
                    <span><i class="fa fa-comments"></i><b class="text"><?php echo $text_comments; ?>:</b> <b class="hl"><?php echo $comment_total; ?></b></span><?php } ?>
                </div>
                ...
                <?php if ($tags) { ?>
                <p class="tags">
                    <?php echo $text_tags; ?>    <?php for ($i = 0; $i < count($tags); $i++) { ?>    <?php if ($i < (count($tags) - 1)) { ?>
                ...
                <?php } ?>
                <!-- Related Products --><?php if ($products) { ?><h3>
                    <i class="fa fa-list"></i><?php echo $text_related_products; ?></h3>
                <div class="blog_grid_holder blog_products column-<?php echo $rel_prod_per_row; ?>">
                    ...
                    <div class="blog_item blog_product">
                        ...
                        <?php } ?><?php if ($product['price']) { ?><p class="price">
                            ...
                            <span class="price-old"><?php echo $product['price']; ?></span><?php } ?><?php if ($product['tax']) { ?>
                            <span class="price-tax"><?php echo $text_tax; ?> <?php echo $product['tax']; ?></span><?php } ?>
                        </p><?php } ?><?php if ((float)VERSION >= 2.1) { ?>
                ...
                <?php } ?>
                <!-- Related Products End --><?php if ($related_blogs) { ?>        <h3>
                    <i class="fa fa-list"></i><?php echo $text_related_blog; ?></h3>
                    ...
                    <div class="blog_item">
                        <div class="summary">
                            ...
                            <div class="blog_stats">
                                ...
                                <span><i class="fa fa-user"></i><b class="text"><?php echo $text_posted_by; ?></b> <b class="hl"><?php echo $blog['author']; ?></b></span><?php } ?><?php if($date_added_status){ ?>
                                <span><i class="fa fa-clock-o"><b class="text"></i><?php echo $text_posted_on; ?></b>
                                    <b class="hl"><?php echo $blog['date_added_full']; ?></b></span><?php } ?>                <?php if($page_view_status){ ?>
                                <span><i class="fa fa-eye"></i><b class="text"><?php echo $text_read; ?></b> <b class="hl"><?php echo $blog['count_read']; ?></b></span><?php } ?>                <?php if($comments_count_status){ ?>
                                <span><i class="fa fa-comments"><b class="text"></i><?php echo $text_comments; ?></b>
                                    <b class="hl"><?php echo $blog['comment_total']; ?></b></span><?php } ?>
                            </div>
                            ...
                            <?php } ?>                <p><?php echo $blog['short_description']; ?></p>
                            <p>
                                <a href="<?php echo $blog['href']; ?>"><?php echo $text_read_more; ?>
                ...
                <?php } ?>
                <!-- Related Blog End -->
                <!-- Comment Area start -->      <?php if($allow_comment){ ?><h3>
                    <i class="fa fa-comments"></i><?php echo $text_comments; ?></h3>
