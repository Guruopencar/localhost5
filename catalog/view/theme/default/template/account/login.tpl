            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="well">
                        ...
                        <a href="<?php echo $register; ?>" class="btn btn-yellow"><?php echo $button_continue; ?></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="well">
                        ...
                        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <input type="submit" value="<?php echo $button_login; ?>" class="btn btn-yellow"/><?php if ($redirect) { ?>
